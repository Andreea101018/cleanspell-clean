...
export default function BeforeAfterPreviewDa() {
      ...
      <div className="relative max-w-7xl mx-auto px-8 py-24">
        ...
        <div className="mb-20 text-center max-w-3xl mx-auto">
          ...
          <p className="mt-6 text-[#64748B]">
            Samme rum, samme vinkel – kun forskellen
          </p>
        </div>
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <ImageBlock src={before} label="Før" onOpen={onOpen} />
        <ImageBlock src={after} label="Efter" green onOpen={onOpen} />
      </div>
    </div>
  );
}
